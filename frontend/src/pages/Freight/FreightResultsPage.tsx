...
export default function FreightResultsPage() {
  ...
  const columns: ColumnsType<FreightResult> = [
    ...
    { title: 'ShippingAve', dataIndex: 'shipping_ave', width: 100 },
    { title: 'MShippingAve', dataIndex: 'shipping_ave_m', width: 100 },
    { title: 'RShippingAve', dataIndex: 'shipping_ave_r', width: 100 },
    { title: 'ShippingMed', dataIndex: 'shipping_med', width: 100 },
    { title: 'RemoteCheck', dataIndex: 'remote_check', width: 100, 
      render: (v?: boolean) => v === true ? 'Yes' : v === false ? 'No' : '-' },

    { title: 'RuralAve', dataIndex: 'rural_ave', width: 100 },
    { title: 'WeightedAveS', dataIndex: 'weighted_ave_s', width: 100 },
    { title: 'ShippingMedDiff', dataIndex: 'shipping_med_dif', width: 120 },
