...
import ProductRunsPage from '@/pages/Products/ProductRunsPage';
import ProductChunkPage from '@/pages/Products/ProductChunkPage';
...
export const router = createBrowserRouter([
  ...
  // 应用布局
  {
    ...
    children: [
      ...
      { path: 'sync-runs', element: <ProductRunsPage /> },
      { path: 'sync-chunks', element: <ProductChunkPage /> },
